...
public class ErrorCtrl {
	...
	public ServerException usernameError(Exception ex) {
		...
		return new ServerException(com.evgateway.server.messages.Error.AUTHENTICATION.toString(),
				Integer.toString(com.evgateway.server.messages.Error.AUTHENTICATION.getCode()), ex);
	}
